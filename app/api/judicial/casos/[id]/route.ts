...
export async function GET(
  ...
  try {
    ...
    const caseItem = {
      ...
      cns: text(row.pacienteCartaoSus || row.cnsBase),
      patientCns: text(row.pacienteCartaoSus || row.cnsBase),
      pacienteCns: text(row.pacienteCartaoSus || row.cnsBase),
      cartaoSus: text(row.pacienteCartaoSus || row.cnsBase),

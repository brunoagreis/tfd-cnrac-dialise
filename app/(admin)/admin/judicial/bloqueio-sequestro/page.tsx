...
export default function JudicialBloqueioSequestroPage() {
  const { user } = useAuth()
  ...
  if (!canAccessJudicialAdmin(user)) {
    return (
      <div className="rounded-xl border border-dashed border-border p-12 text-center text-muted-foreground">
        Somente administradores podem acessar o relatório de bloqueio/sequestro.
      </div>
    )
  }
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Bloqueio / Sequestro</h1>
            <p className="text-sm text-muted-foreground">
              Relatório separado por valores do Estado e do Município.
            </p>
          </div>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Valores separados entre parcela do Estado e parcela do Município.
          </CardDescription>
        </CardHeader>
